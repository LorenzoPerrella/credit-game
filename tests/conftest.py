    ...
    return pd.DataFrame(
        {
            ...
            # The cycle matters: under a monotonically rising index ltv_change becomes
            ...
            "house_price_index": 100.0 * (1.0 + 0.32 * np.sin(months / 41.0)),
            "mortgage_rate_30y": 6.0 + 1.0 * np.cos(months / 33.0),
            "mortgage_rate_15y": 5.4 + 0.9 * np.cos(months / 33.0),
            "financial_conditions_index": 0.35 * np.sin(months / 23.0 + 0.4),
            "fed_funds_rate": 2.5 + 2.0 * np.cos(months / 37.0),
            "treasury_10y": 4.2 + 1.1 * np.cos(months / 44.0),
            "treasury_10y_2y_spread": 1.0 + 0.9 * np.sin(months / 31.0),
            "baa_treasury_spread": 2.4 + 0.8 * np.sin(months / 27.0 + 0.9),
            "consumer_price_index": 160.0 * np.exp(months / 520.0),
            "nasdaq_composite": 2000.0 * (1.0 + 0.45 * np.sin(months / 47.0 + 0.3)),
            "vix_index": 20.0 + 7.0 * np.sin(months / 19.0 + 2.0),
            "consumer_sentiment_index": 85.0 + 12.0 * np.sin(months / 35.0),
